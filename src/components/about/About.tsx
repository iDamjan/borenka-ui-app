          ...
          <div className={classes.sectionTwoContent}>
            ...
            <div className={classes.partTwo}>
              ...
              >
                ...
                релевантни за денешните млади.
                <br />
                <br /> Дел од досегашните програми креирани и спроведени од СИМ
                се програмите: Климатски промени, Scouts 4 SDGs, Биодиверзитет и
                заштита на животната средина, Прва Помош и Заштита, а
                дополнително и Виолетова програма - сеопфатна програма за
                едукација за мултикултурализам и Портокалова програма -
                сеопфатна програма за родова еднаквост.
              </m.p>
            </div>
          </div>
        </div>
